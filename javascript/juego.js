...
// MANTENIMIENTO CORRECTIVO: Declaración de la bandera
...
function asignarListeners(carta) {
    $(carta).click(function() {
        // MANTENIMIENTO CORRECTIVO: Se evita la ejecución si el tablero está bloqueado
        ...
        if (parejaSeleccionada.length > 1) {
            // MANTENIMIENTO CORRECTIVO: Se activa el bloqueo mientras el jugador responde la pregunta
...
function confirmarRespuesta(respuesta, caso) {
    ...
    // MANTENIMIENTO CORRECTIVO: Liberar el tablero una vez que terminó todo el flujo de respuesta
...
if (typeof window !== 'undefined') {
    window.asignarListeners = asignarListeners;
    window.tableroBloqueado = tableroBloqueado;
    window.parejaSeleccionada = parejaSeleccionada;
